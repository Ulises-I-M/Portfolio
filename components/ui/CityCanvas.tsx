...
// Dark fill gives buildings solid mass; bright edges give the neon hologram look
const FACE_FILL  = "rgba(4,12,4,0.82)";   // roof / front face fill
const SIDE_FILL  = "rgba(4,12,4,0.72)";   // side face fill (slightly lighter)
    ...
    for (let col = 0; col < COLS; col++) {
      ...
      switch (type) {
        ...
        case "block":
          ...
          break;
        case "slab":
          // Wide and low — fills most of cell horizontally
...
export default function CityCanvas() {
  ...
  useEffect(() => {
    ...
    // Project 4 coplanar world-space points and fill as polygon
    const fillFace = (
    ...
    const drawTier = (
      ...
      // ── Face fills (back-to-front within tier) ──
      // Side face (left)
      ...
      // ── Edges (wireframe on top of fill) ──
      // Pillars
